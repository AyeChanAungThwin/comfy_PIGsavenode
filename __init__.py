...
try:
    ...
    @PromptServer.instance.routes.post('/pigsavenode/api/categories/rename')
    async def rename_category_route(request):
        from .server import pig_server
        return await pig_server.rename_category(request)

    @PromptServer.instance.routes.post('/pigsavenode/api/favorites/reorder')
    async def reorder_favorites_route(request):
        from .server import pig_server
        return await pig_server.reorder_favorites(request)
